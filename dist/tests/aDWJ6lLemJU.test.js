...
describe("aDWJ6lLemJU pinned no-transcript fixture", () => {
    ...
    it("classifies 'No captions available' as missing and persists transcript_status='missing'", async () => {
        ...
        const spyTranscriptFetcher = async (_id) => {
        ...
        assert.strictEqual(classifierCalls, 1, "classifier must be invoked exactly once — no internal retry");
        const row = getDb()
